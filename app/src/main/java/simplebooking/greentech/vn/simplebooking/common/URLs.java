...
public class URLs {
    private static final String BASE_URL = "http://192.168.1.2:8080/api/rest/v1/";
    ...
    public static final String URL_CUSTOMER_UPLOAD_AVATAR = BASE_URL + "customer-upload-avatar";
}
